...
result_mcmc_GY = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]
...
extra_mcmc_GY = [[[123456] for col in range(num_para*statistics_item)] for row in range(iter_time)]
...
for i in range(iter_time):
    ...
    func_Edit_voc(method,restart_max,mcmc_limit,mcmc_burnin,max_iter)
    func_Edit_vpd(method,cal_type)
    result_mcmc_GY, extra_mcmc_GY = func_Estimation(method,cmd_file_name3,method + '.out',result_mcmc_GY,extra_mcmc_GY,i,SG_switch)
    print('Estimation Finished: ' + method)
    time.sleep(timeout_trial)
...
# 4 - mcmc-GY
method = 'mcmc-GY'
func_Write_output(method,result_mcmc_GY,extra_mcmc_GY)
# 5 - mcmc-GS
method = 'mcmc-GS'
...
result_naive_GY = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]
...
for i in range(iter_time):
    ...
    func_Edit_voc(method,restart_max,mcmc_limit,mcmc_burnin,max_iter)
    func_Edit_vpd(method,cal_type)
    result_naive_GY, _ = func_Estimation(method,cmd_file_name1,method + '.out',result_naive_GY,[],i,SG_switch)
    print('Estimation Finished: ' + method)
    time.sleep(timeout_trial)
...
# 4 - naive-GY
method = 'naive-GY'
func_Write_output(method,result_naive_GY,[])
# 5 - naive-GS
method = 'naive-GS'
...
result_mcmc_kf_w = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]
result_mcmc_kfs_w = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]
result_mcmc_kf_p = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]
result_mcmc_kfs_p = [[[123456] for col in range(num_para+2)] for row in range(iter_time)]

extra_mcmc_kf_w = [[[123456] for col in range(num_para*statistics_item)] for row in range(iter_time)]
extra_mcmc_kfs_w = [[[123456] for col in range(num_para*statistics_item)] for row in range(iter_time)]
extra_mcmc_kf_p = [[[123456] for col in range(num_para*statistics_item)] for row in range(iter_time)]
...
for i in range(iter_time):
    ...
    func_Edit_voc(method,restart_max,mcmc_limit,mcmc_burnin,max_iter)
    func_Edit_vpd(method,cal_type)
    result_mcmc_kf_w, extra_mcmc_kf_w = func_Estimation(method,cmd_file_name5,method + '.out',result_mcmc_kf_w,extra_mcmc_kf_w,i,SG_switch)
    print('Estimation Finished: ' + method)
    time.sleep(timeout_trial)
    ...
    func_Edit_voc(method,restart_max,mcmc_limit,mcmc_burnin,max_iter)
    func_Edit_vpd(method,cal_type)
    result_mcmc_kf_p, extra_mcmc_kf_p = func_Estimation(method,cmd_file_name5,method + '.out',result_mcmc_kf_p,extra_mcmc_kf_p,i,SG_switch)
    print('Estimation Finished: ' + method)
    time.sleep(timeout_trial)
...
# 1 - MKFW
method = 'mcmc_kfw'
func_Write_output(method,result_mcmc_kf_w,extra_mcmc_kf_w)
# 2 - MKFSW
method = 'mcmc_kfsw'
func_Write_output(method,result_mcmc_kfs_w,extra_mcmc_kfs_w)
# 3 - MKFP
method = 'mcmc_kfp'
func_Write_output(method,result_mcmc_kf_p,extra_mcmc_kf_p)
# 4 - MKFSP
method = 'mcmc_kfsp'
